...
for ds_name, dataset in zip(datasets, datasets_data):
  ...
  five_datasets.append([*dataset(download=True, split="train",transform=tranformations, as_rgb=False),
                        *dataset(download=True, split="test",transform=tranformations, as_rgb=False),
                        *dataset(download=True, split="val",transform=tranformations, as_rgb=False)][:max_dataset_size])
